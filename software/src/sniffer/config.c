...
//---------------- Commands ----------------//
static const char cmd_string_chn[] PROGMEM = "chn";
static const char help_string_chn[] PROGMEM = "<n>\n"
    "Sets the MIDI receive channel to sniff on:\n"
    "<n> : channel number [1..16] or 'x' for Omni mode";
struct serial_command serial_commands[] = {
    { .cmd_string = cmd_string_chn, .help_string = help_string_chn, .handler = &exec_channel },
};
