...
/// \details    Descriptors are special computer-readable structures which the host requests
///             upon device enumeration, to determine the device's capabilities and functions.
